...
set TopBrandsName as
	generate(TopBrands,{TopBrands.current(0)})

set OthersCorporation as
	IIF("YES"="YES",
		(
			order (
				nonempty(
					{(except([DimCorporation].[CorporationCode].[CorporationCode].members,TopBrandsName),
					[DimFranchiseBrand].[TypeOfBrands].[All],
					[DimChannel].[TypeOfBrands].[All],
	...
	nonempty(
		{
			...
			else
			{
				IIF([DimCorporation].[CorporationCode].[TotalSales] <> 0,
					...
					,[DimFranchiseBrand].[TypeOfBrands].[All]
					,[DimChannel].[TypeOfBrands].[All]
					,[DimCorporation].[CorporationMncFlag].[All],[DimLevel].[Num].&[1])
					,null),
				...
				IIF("YES"="YES",
					...
					IIF([DimCorporation].[CorporationCode].[NovartisOtherSum] <> 0,
						...
						,[DimFranchiseBrand].[TypeOfBrands].[All]
						,[DimChannel].[TypeOfBrands].[All]
						,[DimCorporation].[CorporationMncFlag].[All],[DimLevel].[Num].&[3])
						,null)
				),
				
				IIF("YES"="YES",
					(OthersCorporation,[DimLevel].[Num].&[4]),
					null
				)
